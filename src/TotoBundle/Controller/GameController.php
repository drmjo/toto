...
class GameController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $games = $em->getRepository('TotoBundle:Game')->findAll();
    ...
    {
        $game = new Game();
        $form = $this->createForm('TotoBundle\Form\GameType', $game);
    ...
    {
        $deleteForm = $this->createDeleteForm($game);
        $editForm = $this->createForm('TotoBundle\Form\GameType', $game);
